...
class DATA_LOADER(object):
    ...
    def read_matimagenet(self, opt):
        ...
        self.nunseen = self.test_unseen_feature.size()[0]
    ...
    def read_matdataset(self, opt):
        ...
        self.ntrain = self.train_feature.size()[0]
        self.nunseen = self.test_unseen_feature.size()[0]
        self.ntest = self.test_unseen_feature.size()[0] + self.test_seen_feature.size()[0]
        self.ntrain_class = self.seenclasses.size(0)
        self.ntest_class = self.unseenclasses.size(0)
        ...
        self.ntest_seen_label = torch.unique(self.test_seen_label)
        self.ntest_seen_label_instance = test_seen_loc
        self.ntest_unseen_label = torch.unique(self.test_unseen_label)
    ...
    def next_batch_unseen(self, batch_size):
        idx = torch.randperm(self.nunseen)[0:batch_size]
