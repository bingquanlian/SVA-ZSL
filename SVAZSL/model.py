...
class Generator(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.fc1 = nn.Linear(input_size, layer_sizes[0])  # 624 -> 4096
        self.fc3 = nn.Linear(layer_sizes[0], layer_sizes[1])  # 4096 -> 2048
        self.lrelu = nn.LeakyReLU(0.2, True)
...
class Embedding_Net(nn.Module):
    def __init__(self, opt):
        ...
        self.fc1 = nn.Linear(opt.resSize, opt.embedding_size)
        self.lrelu = nn.LeakyReLU(0.2, True)
